...
[![npm version](https://badge.fury.io/js/%40jbr-experiment%2Fwatdiv.svg)](https://www.npmjs.com/package/@jbr-experiment/sparql-custom)

A [jbr](https://github.com/rubensworks/jbr.js/tree/master/packages/jbr) experiment type for a custom defined set of queries.
...
* `queriesPath`: Path to a directory of SPARQL queries relative to the experiment root, which will be parsed using [sparql-benchmark-runner.js](https://github.com/comunica/sparql-benchmark-runner.js).
