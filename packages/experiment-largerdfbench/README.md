# JBR Experiment - LargeRDFBench

[![Build status](https://github.com/rubensworks/jbr.js/workflows/CI/badge.svg)](https://github.com/rubensworks/jbr.js/actions?query=workflow%3ACI)
[![Coverage Status](https://coveralls.io/repos/github/rubensworks/jbr.js/badge.svg?branch=master)](https://coveralls.io/github/rubensworks/jbr.js?branch=master)
[![npm version](https://badge.fury.io/js/%40jbr-experiment%2Flargerdfbench.svg)](https://www.npmjs.com/package/@jbr-experiment/largerdfbench)

A [jbr](https://github.com/rubensworks/jbr.js/tree/master/packages/jbr) experiment type for [LargeRDFBench](https://github.com/dice-group/LargeRDFBench?tab=readme-ov-file).
...
```bash
$ jbr init largerdfbench my-experiment
$ cd my-experiment
```
...
```json
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@jbr-experiment/largerdfbench/^1.0.0/components/context.jsonld"
  ],
  "@id": "urn:jrb:test-largerdfbench2",
  "@type": "ExperimentLargeRdfBench",
  "datasetScale": 1,
  "queryCount": 5,
  "queryRecurrence": 1,
  "generateHdt": true,
  ...
  "hookSparqlEndpoint": {
    "@id": "urn:jrb:test-largerdfbench2:hookSparqlEndpoint",
